...
// Constantes de dominio completas
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <FormControl fullWidth size="small">
              ...
              <Select 
                ...
                renderValue={(selected) => <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>{selected.map((value) => <Chip key={value} label={value} size="small" color="primary" />)}</Box>}
              >
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <FormControl fullWidth size="small">
              ...
              <Select 
                ...
                renderValue={(selected) => <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>{selected.map((value) => <Chip key={value} label={value} size="small" variant="outlined" />)}</Box>}
              >
